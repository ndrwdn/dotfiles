...
if main_syntax != 'java' || exists("java_css")
  ...
  unlet b:current_syntax
  syn region cssStyle start=+<style+ keepend end=+</style>+ contains=@htmlCss,htmlTag,htmlEndTag,htmlCssStyleComment,@htmlPreproc fold
...
if exists("b:html_fold")
"   syntax region htmlHeadBlock start=/<head/ end=/<\/head>/ skipwhite transparent fold keepend
"   syntax region htmlBodyBlock start=/<body/ end=/<\/body>/ skipwhite transparent fold keepend
   syntax region htmlDivBlock start=/<div/ end=/<\/div>/ skipwhite transparent fold keepend extend
   syntax region htmlTableBlock start=/<table/ end=/<\/table>/ skipwhite transparent fold keepend
