...
(let ((class '((class color)  (min-colors 89)))
      (ujelly-fg "#e8e8d3")
      (ujelly-bg "#000000")
      (ujelly-modeline-active-bg "#404040")
      (ujelly-modeline-inactive-bg "#484848")
      (ujelly-modeline-inactive-fg "#a0a0a0")
  ...
  (custom-theme-set-faces
    ...
    `(mode-line ((,class (:foreground ,ujelly-fg :background ,ujelly-modeline-active-bg))))
    `(mode-line-inactive ((,class (:foreground ,ujelly-modeline-inactive-fg :background ,ujelly-modeline-inactive-bg))))
